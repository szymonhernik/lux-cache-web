...
type Props = {
  hiddenTagsResults: SearchQueryResult['hiddenTags']
}
export default function HiddenTagsResults(props: Props) {
  const { hiddenTagsResults } = props
  return (
    <div className="flex flex-col gap-4">
      {hiddenTagsResults.map((post) => (
